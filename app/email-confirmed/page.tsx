      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white border border-gray-200 rounded-2xl p-8 lg:p-12 text-center shadow-sm">
          ...
          <div className="bg-gray-50 rounded-xl p-6 mb-8">
            <p className="text-sm text-gray-500 uppercase tracking-wide font-semibold mb-4">Next Steps</p>
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center">
                <div className="w-10 h-10 bg-black text-white rounded-full flex items-center justify-center mx-auto mb-2 text-sm font-bold">
                  1
                </div>
                <p className="text-gray-700 text-sm">Open extension</p>
              </div>
              <div className="text-center">
                <div className="w-10 h-10 bg-black text-white rounded-full flex items-center justify-center mx-auto mb-2 text-sm font-bold">
                  2
                </div>
                <p className="text-gray-700 text-sm">Log in</p>
              </div>
              <div className="text-center">
                <div className="w-10 h-10 bg-black text-white rounded-full flex items-center justify-center mx-auto mb-2 text-sm font-bold">
                  3
                </div>
                <p className="text-gray-700 text-sm">Find mobiles!</p>
              </div>
            </div>
          </div>
